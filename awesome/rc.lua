...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "r", function () awful.util.spawn( "/home/aljaz/.config/rofi/launchers/misc/launcher.sh" ) end,
    ...
    awful.key({ modkey }, "x",  function () awful.util.spawn( "/home/aljaz/.config/rofi/applets/android/powermenu.sh" ) end,
...
--Media keys supported by mpd.
    ...
    awful.key({}, "XF86AudioStop", function () awful.util.spawn("sp pause") end),
